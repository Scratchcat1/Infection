...
class Machine():
    def Startup(input_val,Use_File,Pygame_Enable):
    ...
    ##    Use_File = input("Open file? [Yes or No]").lower()
        if Use_File == True:
            File_Content =[]
            Population,Population_Size,Possible_friends,radius = Open_File(Population,Population_Size,Possible_friends,xpixel,ypixel,input_val)
        ...
        day =1
        return Population, Population_Size,Possible_friends,radius,day    
    ...
    def Open_File(Population,Population_Size,Possible_friends,xpixel,ypixel,filename):
    ...
    def Days(Autodays,Population,Pygame_Enable):
    ...
    def Save_Go(self,Population,filename):
        self.A_or_W = "w"
        Save(self.Population,filename,self.A_or_W)
