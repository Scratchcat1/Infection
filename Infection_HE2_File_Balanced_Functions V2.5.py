...
class window(Frame):
    ...
    def Main_Menu(self):
        ...
        Button(main,text ="Add file",command=lambda : Machine1.Open_File(openfile.get())).grid(row=3,column = 5,padx=5,pady=5)
        ...
        Button(main,text ="Shuffle Friends",command=lambda : self.Multiply(e1.get(),e2.get())).grid(row=6,column = 0,padx=5,pady=5)
        Button(main,text ="Infect Analysis",command=lambda : self.Multiply(e1.get(),e2.get())).grid(row=6,column = 1,padx=5,pady=5)
